    ...
    updateShape_: function (this: any) {
        ...
        if (this.showSettings_ && !hasInput) {
            this.appendDummyInput("CONNECTION")
                .appendField(Blockly.Msg["PIB_RUN_SCRIPT_HOST"] || "host")
                .appendField(
                ...
                .appendField(Blockly.Msg["PIB_RUN_SCRIPT_USER"] || "user")
                .appendField(
                ...
                .appendField(Blockly.Msg["PIB_RUN_SCRIPT_PASSWORD"] || "password")
                .appendField(
                ...
                .appendField(Blockly.Msg["PIB_RUN_SCRIPT_PORT"] || "port")
                .appendField(
    ...
    [
        {
            ...
            nextStatement: null,
            colour: 45,
            tooltip: "%{BKY_PIB_RUN_SCRIPT_TOOLTIP}",
            helpUrl: "",
            mutator: "run_script_connection_mutator",
        },
        {
            type: "run_script_mutator_container",
            message0: "%{BKY_PIB_RUN_SCRIPT_CONN_SETTINGS}",
            args0: [
                {type: "input_dummy"},
                {type: "input_statement", name: "STACK"},
            ],
            colour: 45,
            tooltip: "%{BKY_PIB_RUN_SCRIPT_CONN_TOOLTIP}",
            helpUrl: "",
        },
        {
            type: "run_script_mutator_item",
            message0: "%{BKY_PIB_RUN_SCRIPT_USE_CUSTOM}",
            previousStatement: null,
            nextStatement: null,
            colour: 45,
            tooltip: "%{BKY_PIB_RUN_SCRIPT_USE_CUSTOM_TOOLTIP}",
            helpUrl: "",
        },
    ],
);
